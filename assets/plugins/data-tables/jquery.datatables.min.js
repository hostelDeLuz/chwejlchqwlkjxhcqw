...
(function (l) {
  ...
  function Kb(a) {
    var b = a.oClasses,
      ...
      e = a.oPreviousSearch,
      h = a.aanFeatures,
      f = '<input type="search" className="' + b.sFilterInput + '"/>',
      g = d.sSearch;
  ...
  function Ha(a) {
    ...
    if (a.scrollBarVis !== fa && a.scrollBarVis !== q)
      ...
      G &&
        ...
        l(ba).height(0));
      ca(function (D, W) {
        D.innerHTML = '<div className="dataTables_sizing">' + H[W] + "</div>";
      ...
      G &&
        ca(function (D, W) {
          D.innerHTML = '<div className="dataTables_sizing">' + ea[W] + "</div>";
          D.childNodes[0].style.height = "0";
          D.childNodes[0].style.overflow = "hidden";
          D.style.width = I[W];
        }, ba);
          ...
          t = function (x, w) {
            ...
            for (r = w.length; aa < r; aa++) {
              ...
              if (Array.isArray(L)) {
                ...
                switch (L) {
                  case "ellipsis":
                    x.append('<span className="ellipsis">&#x2026;</span>');
                    break;
                  case "first":
                    m = g.sFirst;
                    0 === e && ((O = -1), (n += " " + C));
